...
<input type="button" name="addrow" class="addrow" id="addrow" value="Add Row" onclick="addRow()"/>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	for ($i = 0; $i < $totalTableRow; $i++) {
		...
		<td><input type="text" name="subjectEnglish[]" class="subjectEnglish" id="subjectEnglish" value="' . $tableValue[$i][0] . '"/></td>
		<td><input type="text" name="subjectGerman[]" class="subjectGerman" id="subjectGerman" value="' . $tableValue[$i][1] . '"/></td>
		...
		<td><input type="text" name="note[]" class="note" id="note" value="' . $tableValue[$i][3] . '" ' . $noteField[$i] .'/></td>
		...
		<td><input type="text" name="attempt[]" class="attempt" id="attempt" value="' . $tableValue[$i][5] . '"/></td>
